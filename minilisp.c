...
// Returns ((x . y) . a)
static Obj *acons(Obj *x, Obj *y, Obj *a) { return cons(cons(x, y), a); }
...
// (list expr ...)
static Obj *prim_list(Obj *env, Obj *list) { return eval_list(env, list); }
...
// (exit)
static Obj *prim_exit(Obj *env, Obj *list) { exit(0); }
